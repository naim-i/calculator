...
export default function Calculator() {
  ...
  return (
    <div className=" h-2/4 flex items-center justify-center bg-[#0F0F0F] p-24">
      <motion.div
      ...
      >
        ...
        {/* History Panel */}
        <div className="backdrop-blur-xl bg-white/10 border border-white/20 p-6 rounded-3xl shadow-2xl h-full max-h-[600px] overflow-y-auto text-white">
